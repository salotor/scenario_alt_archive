...
label after_load:
    ...
    if save_name.find(u'7ДЛ') != -1: #Если нашли вхождение '7ДЛ' в имени сохранения игры
        ...
        # steam. Откатываем имена персонажей. FIXME: возможно следовало бы добавить проверку на активную сессию 7ДЛ? пара БЕГЛЫХ тестов показали без этого всё работает нормально, но..
        $ revert_names()
