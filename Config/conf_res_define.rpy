...
#Задники
    ...
    image bg ext_mv2_7dl = get_image_7dl("bg/ext_mv2_7dl.jpg")
    ...
    image bg int_potato_storage_7d = get_image_7dl("bg/int_potato_storage_7d.png")
...
#Новьё
    ...
    $ uneven_me = get_music_7dl("uneven_me.ogg")#Мятущаяся душа
