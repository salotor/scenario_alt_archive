...
screen sdl_achvlist_character(character, route_list):
    ...
    for route in route_list:
        ...
        if sdl_achv_selected_route == route:
            add route.get_icon_active() pos (653 + 78 * sdl_achv_x_shift, 12 + 46 * sdl_achv_y_shift)     #moded
        else:
            imagebutton pos (653 + 78 * sdl_achv_x_shift, 12 + 46 * sdl_achv_y_shift):     #moded
                hover_sound sdl_achv_click
