...
#music
    $ alice_theme_7dl = get_music_7dl("alice_theme_7dl.ogg")
    $ afraid_of_destiny_7dl = get_music_7dl("afraid_of_destiny_7dl.ogg")
    $ anglegrinder_7dl = get_music_7dl("anglegrinder_7dl.ogg")
    $ areyouabully_7dl = get_music_7dl("areyouabully_7dl.ogg")
    $ are_you_there_7dl = get_music_7dl("are_you_there_7dl.ogg")
    $ ask_you_out_7dl = get_music_7dl("ask_you_out_7dl.ogg")
    
    $ bad_apple_7dl = get_music_7dl("bad_apple_7dl.ogg")
    $ beat_symphonic_7dl = get_music_7dl("beat_symphonic_7dl.ogg")
    $ beth_7dl = get_music_7dl("beth_7dl.ogg")
    $ but_why_7dl = get_music_7dl("but_why_7dl.ogg")
    $ breath_again_7dl = get_music_7dl("breath_again_7dl.ogg")
    $ breath_me_7dl = get_music_7dl("breath_me_7dl.ogg")
    $ beasteye_7dl = get_music_7dl("beasteye_7dl.ogg")
    
    $ catch_the_hedge_7dl = get_music_7dl("catch_the_hedge_7dl.ogg")
    $ christmas_met_7dl = get_music_7dl("christmas_met_7dl.ogg")
    $ closetoyou_7dl = get_music_7dl("closetoyou_7dl.ogg")
    $ clueless_hope_7dl = get_music_7dl("clueless_hope_7dl.ogg")
    
    $ danceagain_7dl = get_music_7dl("danceagain_7dl.ogg")
    $ dance_with_me_7dl = get_music_7dl("dance_with_me_7dl.ogg")
    $ dance_with_me_piano_7dl = get_music_7dl("dance_with_me_piano_7dl.ogg")
    $ deadman_7dl = get_music_7dl("deadman_7dl.ogg")
    $ dead_silence_7dl = get_music_7dl("dead_silence_7dl.ogg")
    $ deep_inside_7dl = get_music_7dl("deep_inside_7dl.ogg")
    $ dropit_7dl = get_music_7dl("dropit_7dl.ogg")
    $ dv_guitar_7dl = get_music_7dl("dv_guitar_7dl.ogg")

    $ escape_2_7dl = get_music_7dl("escape_2_7dl.ogg")
    $ exodus_7dl = get_music_7dl("Exodus_7dl.ogg")
    $ emptiness_7dl = get_music_7dl("emptiness_7dl.ogg")
    $ es_downmix_7dl = get_music_7dl("es_downmix_7dl.ogg")
    $ Everlasting_Summer_Alice_7dl = get_music_7dl("Everlasting_Summer_Alice_7dl.ogg")
    
    $ feel_you_inside_7dl = get_music_7dl("feel_you_inside_7dl.ogg")
    $ finale_farewell_7dl = get_music_7dl("finale_farewell_7dl.ogg")
    $ forgive_or_what_7dl = get_music_7dl("forgive_or_what_7dl.ogg")
    $ frostwithoutyou_7dl = get_music_7dl("frostwithoutyou_7dl.ogg")
    $ fsl_tn_7dl = get_music_7dl("fsl_tn_7dl.ogg")
    
    $ genki_7dl = get_music_7dl("genki_7dl.ogg")
    $ guitar_under_the_window_7dl = get_music_7dl("guitar_under_the_window_7dl.ogg")
    $ groovie_7dl = get_music_7dl("groovie_7dl.ogg")
    $ gonna_be_ok_7dl = get_music_7dl("gonna_be_ok_7dl.ogg")
    
    $ happy_ending_7dl = get_music_7dl("happy_ending_7dl.ogg")
    $ herc_death_7dl = get_music_7dl("herc_death_7dl.ogg")
        
    $ iamagod2_7dl = get_music_7dl("iamagod2_7dl.ogg")
    $ iamsadiamsorry3_7dl = get_music_7dl("iamsadiamsorry3_7dl.ogg")
    $ iamsadiamsorry2_7dl = get_music_7dl("iamsadiamsorry2_7dl.ogg")
    $ iamsadiamsorry_7dl = get_music_7dl("iamsadiamsorry_7dl.ogg")
    $ intro1_7dl = get_music_7dl("intro1_7dl.ogg")
    $ intro2_7dl = get_music_7dl("intro2_7dl.ogg")
    $ iwantmagic_7dl = get_music_7dl("iwantmagic_7dl.ogg")
    
    $ knock_7dl = get_music_7dl("knock_7dl.ogg")
    $ kiss_you_7dl = get_music_7dl("kiss_you_7dl.ogg")
    
    $ lastlight_guitar_7dl = get_music_7dl("lastlight_guitar_7dl.ogg")
    $ lastlight_piano_7dl = get_music_7dl("lastlight_piano_7dl.ogg")
    $ laugh_throught_the_universe_7dl = get_music_7dl("laugh_throught_the_universe_7dl.ogg")
    $ lazy_olga_7dl = get_music_7dl("lazy_olga_7dl.ogg")
    $ last_pixie_7dl = get_music_7dl("last_pixie_7dl.ogg")
    $ lonesome_shepherd_7dl = get_music_7dl("lonesome_shepherd_7dl.ogg")
    $ liliac_ball_7dl = get_music_7dl("liliac_ball_7dl.ogg")
    $ loki_on_3_7dl = get_music_7dl("loki_on_3_7dl.ogg")
    $ lullaby2_7dl = get_music_7dl("lullaby2_7dl.ogg")
    $ lost_without_you_7dl = get_music_7dl("lost_without_you_7dl.ogg")
    $ longing_7dl = get_music_7dl("longing_7dl.ogg")
    $ ltyh_7dl = get_music_7dl("ltyh_7dl.ogg")
    $ lunar_anguish_7dl = get_music_7dl("lunar_anguish_7dl.ogg")
    $ lyrica_sg_7dl = get_music_7dl("lyrica_sg_7dl.ogg")
    $ lynn_7dl = get_music_7dl("lynn_7dl.ogg")

    $ mammal_7dl = get_music_7dl("mammal_7dl.ogg")
    $ meetmethere_tts_7dl = get_music_7dl("meetmethere_tts_7dl.ogg")
    $ me2ost_7dl = get_music_7dl("me2ost_7dl.ogg")
    $ melancholy_sun_7dl = get_music_7dl("melancholy_sun_7dl.ogg")
    ...
    $ nowyouseeme_7dl = get_music_7dl("nowyouseeme_7dl.ogg")
    
    $ old_kiss_7dl = get_music_7dl("old_kiss_7dl.ogg")
    $ ourfirstmet_7dl = get_music_7dl("ourfirstmet_7dl.ogg") 
    $ outer_7dl = get_music_7dl("Outer_Science_7dl.ogg") 
    $ out_of_your_tier_7dl = get_music_7dl("out_of_your_tier_7dl.ogg") 
    $ out_of_painkillers_7dl = get_music_7dl("out_of_painkillers_7dl.ogg") 
    
    $ pathways_7dl = get_music_7dl("pathways_7dl.ogg")
    $ Please_Reprise_7dl = get_music_7dl("Please_Reprise_7dl.ogg")
    $ pixies_playing_7dl = get_music_7dl("pixies_playing_7dl.ogg")
    $ polyhymnia_intro_7dl = get_music_7dl("polyhymnia_intro_7dl.ogg")
    $ polyhymnia_main_7dl = get_music_7dl("polyhymnia_main_7dl.ogg")
    $ ppk_7dl = get_music_7dl("ppk_7dl.ogg")
    $ prologue_1_7dl = get_music_7dl("prologue_1_7dl.ogg")
    $ promise_to_meet_you_7dl = get_music_7dl("promise_to_meet_you_7dl.ogg")

    $ Redemption_7dl = get_music_7dl("Redemption_7dl.ogg")
    $ red_lights_7dl = get_music_7dl("red_lights_7dl.ogg")
    $ refuse_to_believe_7dl = get_music_7dl("refuse_to_believe_7dl.ogg")
    $ refuse_to_replay_7dl = get_music_7dl("refuse_to_replay_7dl.ogg")
    $ rewind_7dl = get_music_7dl("rewind_7dl.ogg")
    $ rightroad_7dl = get_music_7dl("rightroad_7dl.ogg")
    $ ritual2_7dl = get_music_7dl("ritual2_7dl.ogg")
    $ runaway_7dl = get_music_7dl("runaway_7dl.ogg")
    
    $ Sad_Piano_7dl = get_music_7dl("Sad_Piano_7dl.ogg")
    $ sam_lullaby_7dl = get_music_7dl("sam_lullaby_7dl.ogg")
    $ scorpions_7dl = get_music_7dl("scorpions_7dl.ogg")
    $ Semische_7dl = get_music_7dl("Semische_7dl.ogg")
    $ seven_summer_days_7dl = get_music_7dl("seven_summer_days_7dl.ogg")
    $ sign_of_blood_7dl = get_music_7dl("sign_of_blood_7dl.ogg")
    $ silent_angel_7dl = get_music_7dl("silent_angel_7dl.ogg")
    $ sh_ai_rejuv_7dl = get_music_7dl("sh_ai_rejuv_7dl.ogg")
    $ shape_of_my_heart_7dl = get_music_7dl("shape_of_my_heart_7dl.ogg")
    $ sheiscool_7dl = get_music_7dl("sheiscool_7dl.ogg")
    $ shehasgone_7dl = get_music_7dl("shehasgone_7dl.ogg")
    $ shib_mono_7dl = get_music_7dl("shib_mono_7dl.ogg")
    $ shib_stereo_7dl = get_music_7dl("shib_stereo_7dl.ogg")
    $ slavyas_fantazm_7dl = get_music_7dl("slavyas_fantazm_7dl.ogg")
    $ sky_feather_7dl = get_music_7dl("sky_feather_7dl.ogg")
    $ sneakupon_7dl = get_music_7dl("sneakupon_7dl.ogg")
    $ so_cold_7dl = get_music_7dl("so_cold_7dl.ogg")
    $ so_lonely_7dl = get_music_7dl("so_lonely_7dl.ogg")
    $ someone_like_you_guitar_7dl = get_music_7dl("someone_like_you_guitar_7dl.ogg")
    $ splin_7dl = get_music_7dl("splin1_7dl.ogg")
    $ stilllovingyou_7dl = get_music_7dl("stilllovingyou_7dl.ogg")
    $ summer_ends_soon2_7dl = get_music_7dl("summer_ends_soon2_7dl.ogg")

    $ take_my_hand_7dl = get_music_7dl("take_my_hand_7dl.ogg")
    $ tears_of_7dl = get_music_7dl("tears_of_7dl.ogg")
    $ tellyourworld_7dl = get_music_7dl("tellyourworld_7dl.ogg")
    $ temptation_7dl = get_music_7dl("temptation_7dl.ogg")
    $ tender_song_7dl = get_music_7dl("tender_song_7dl.ogg")
    $ there_you_are_7dl = get_music_7dl("loop_there_you_are!_7dl.ogg")
    $ the_way_7dl = get_music_7dl("the_way_7dl.ogg")
    $ thousand_little_things_7dl = get_music_7dl("thousand_little_things_7dl.ogg")
    $ thousand_of_pixies_7dl = get_music_7dl("thousand_of_pixies_7dl.ogg")
    $ tilltheend_7dl = get_music_7dl("tilltheend_7dl.ogg")
    $ timetowakeup_7dl = get_music_7dl("timetowakeup_7dl.ogg")
    $ to_the_sunrise_7dl = get_music_7dl("to_the_sunrise_7dl.ogg")
    $ too_quiet_7dl = get_music_7dl("too_quiet_7dl.ogg")
    
    $ uncertainity_7dl = get_music_7dl("uncertainity_7dl.ogg")
    $ unfulfilled_7dl = get_music_7dl("unfulfilled_7dl.ogg")
    $ uneven_me_7dl = get_music_7dl("uneven_me_7dl.ogg")
    $ unfinished_life_7dl = get_music_7dl("unfinished_life_7dl.ogg")
    $ unforgotten_7dl = get_music_7dl("Unforgotten_7dl.ogg")
    $ unholy_you_7dl = get_music_7dl("unholy_you_7dl.ogg")
    
    $ vale_7dl = get_music_7dl("vale_7dl.ogg")
    $ vampire_7dl = get_music_7dl("vampire_7dl.ogg")
    
    $ walkingaway_7dl = get_music_7dl("walkingaway_7dl.ogg")
    $ what_am_i_doing_here_7dl = get_music_7dl("what_am_i_doing_here_7dl.ogg")
    $ what_cost_7dl = get_music_7dl("what_cost_7dl.ogg")
    $ whatnow_7dl = get_music_7dl("whatnow_7dl.ogg")
    $ wheres_wonderland_7dl = get_music_7dl("wheres_wonderland_7dl.ogg")
    $ will_you_7dl = get_music_7dl("will_you_7dl.ogg")
    $ wonderful_faraway_7dl = get_music_7dl("wonderful_faraway_7dl.ogg")
    
    $ you_were_late_7dl = get_music_7dl("you_were_late_7dl.ogg")
    $ you_are_human_7dl = get_music_7dl("you_are_human_7dl.ogg")
    $ you_are_soul_7dl = get_music_7dl("you_are_soul_7dl.ogg")
    $ you_are_star_7dl = get_music_7dl("you_are_star_7dl.ogg")
    $ youareours_7dl = get_music_7dl("youareours_7dl.ogg")
    $ youre_not_real_7dl = get_music_7dl("youre_not_real_7dl.ogg")
    $ your_life_7dl = get_music_7dl("your_life_7dl.ogg")
    
# sfx
    $ apple_bite_7dl = get_sfx_7dl("apple_bite_7dl.ogg")
    $ aunl_7dl = get_sfx_7dl("aunl_7dl.ogg")
    $ bed_squeak_7dl = get_sfx_7dl("bed_squeak_7dl.ogg")
    $ brake_7dl = get_sfx_7dl("brake_7dl.ogg")
    $ breath_7dl = get_sfx_7dl("breath_7dl.ogg")
    $ blanket_7dl = get_sfx_7dl("blanket_7dl.ogg")
    $ car_passing_7dl = get_sfx_7dl("car_passing_7dl.ogg")
    $ deagle_shot_7dl = get_sfx_7dl("deagle_shot_7dl.ogg")
    $ eat_horn_7dl = get_sfx_7dl("eat_horn_7dl.ogg")
    $ footsteps_grass_7dl = get_sfx_7dl("footsteps_grass_7dl.ogg")
    $ ghmm_7dl = get_sfx_7dl("ghm_7dl.ogg")
    $ hedgehog_7dl = get_sfx_7dl("hedgehog_7dl.ogg")
    $ highfive_7dl = get_sfx_7dl("highfive_7dl.ogg")
    $ intro_dr_7dl = get_sfx_7dl("intro_dr_7dl.ogg")
    $ KBtyping_7dl = get_sfx_7dl("KBtyping_7dl.ogg")
    $ kissing_sound_7dl = get_sfx_7dl("kissing_sound_7dl.ogg")
    $ makarych_7dl = get_sfx_7dl("makarych_7dl.ogg")
    $ miku_stomping_7dl = get_sfx_7dl("miku_stomping_7dl.ogg")
    $ metal_hit_on_metal_7dl = get_sfx_7dl("metal_hit_on_metal_7dl.ogg")
    $ mpbt_7dl = get_sfx_7dl("mpbt_7dl.ogg")
    $ phone_feedback_7dl = get_sfx_7dl("phone_feedback_7dl.ogg")
    $ pouring_7dl = get_sfx_7dl("pouring_7dl.ogg")
    $ pup_bark_7dl = get_sfx_7dl("pup_bark_7dl.ogg")
    $ push_the_button_7dl = get_sfx_7dl("push_the_button_7dl.ogg")
    $ raindrops_radio_7dl = get_sfx_7dl("raindrops_radio_7dl.ogg")
    $ reverse_bell_7dl = get_sfx_7dl("reverse_bell_7dl.ogg")
    $ ringtone_7dl = get_sfx_7dl("ringtone_7dl.ogg")
    #Озвучка заголовка роли by Noir Сычёв
    $ role_drisch_7dl = get_sfx_7dl("role_drisch_7dl.ogg")
    $ role_herc_7dl = get_sfx_7dl("role_herc_7dl.ogg")
    $ role_loki_7dl = get_sfx_7dl("role_loki_7dl.ogg")
    $ sigh_out_7dl = get_sfx_7dl("sigh_out_7dl.ogg")
    $ snap_7dl = get_sfx_7dl("snap_7dl.ogg")
    $ stahp_7dl = get_sfx_7dl("stahp_7dl.ogg")
    $ tearing_7dl = get_sfx_7dl("tearing_7dl.ogg")
    $ tousche_7dl = get_sfx_7dl("tousche_7dl.ogg")
    $ train_depart_7dl = get_sfx_7dl("train_depart_7dl.ogg")
    $ train_income_7dl = get_sfx_7dl("train_income_7dl.ogg")
    $ nesmogla_7dl = get_sfx_7dl("nesmogla_7dl.ogg")
    $ volley_hit_7dl = get_sfx_7dl("volley_hit_7dl.ogg")
    $ wakeup_horn_7dl = get_sfx_7dl("wakeup_horn_7dl.ogg")
    $ wakeup_7dl = get_sfx_7dl("wakeup_7dl.ogg")
    $ white_noise_7dl = get_sfx_7dl("white_noise_7dl.ogg")
    $ window_glass_break_7dl = get_sfx_7dl("window_glass_break_7dl.ogg")