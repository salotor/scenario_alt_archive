...
label alt_day0_vars: #Переменные нулевого дня
    ...
    if persistent.dv_7dl_true and persistent.un_7dl_true and persistent.mi_7dl_true and persistent.mt_7dl_true and persistent.sl_7dl_true and persistent.us_7dl_true: # условия не соответствуют появлению кусочков паззла
        $ alt_day_binder = 1
    else:
        $ alt_day_binder = 0
    return
