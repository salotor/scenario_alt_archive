...
######## Тени ########
#Жужа 1
    image mz shade = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/mz/mz_1_body.png'), (0, 0), get_sprite_ori('normal/mz/mz_1_pioneer.png')), im.matrix.tint(0.01, 0.01, 0.01) ) 
#ОД 1    
    image mt shade = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/mt/mt_1_body.png'), (0, 0), get_sprite_ori('normal/mt/mt_1_pioneer.png')), im.matrix.tint(0.01, 0.01, 0.01) )
...
#Славя 1
    image sl shade  = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/sl/sl_1_body.png'), (0, 0), get_sprite_ori('normal/sl/sl_1_pioneer.png')), im.matrix.tint(0.01, 0.01, 0.01) )
    image sl2 shade = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_7dl('normal/sl/sl_1_body2.png'), (0, 0), get_sprite_ori('normal/sl/sl_1_dress.png')), im.matrix.tint(0.01, 0.01, 0.01) )
...
#Унылка 1
    image un shade = At(im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/un/un_1_body.png'), (0, 0), get_sprite_7dl('normal/un/un_1_modern.png')), im.matrix.tint(0.01, 0.01, 0.01) ), close_sprites)
...
#Мику
    ...
    image mi shade = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/mi/mi_1_body.png'), (0, 0), get_sprite_ori('normal/mi/mi_1_pioneer.png')), im.matrix.tint(0.01, 0.01, 0.01) )
    image mi shade far = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('far/mi/mi_2_body.png'), (0, 0), get_sprite_ori('far/mi/mi_2_pioneer.png')), im.matrix.tint(0.01, 0.01, 0.01) )
#Дваче 4
    image dv shade = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_ori('normal/dv/dv_4_body.png'), (0, 0), get_sprite_ori('normal/dv/dv_4_pioneer.png')), im.matrix.tint(0.01, 0.01, 0.01) )
#Ульяна
