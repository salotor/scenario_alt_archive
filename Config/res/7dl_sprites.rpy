...
#Славя 1
    ...
    image sl2_shade = im.MatrixColor(im.Composite((900, 1080), (0, 0), get_sprite_7dl('normal/sl/sl2_1_body.png'), (0, 0), get_sprite_ori('normal/sl/sl_1_dress.png')), im.matrix.tint(0.01, 0.01, 0.01) )
