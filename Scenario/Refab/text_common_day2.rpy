label alt_day2_begin:
    ...
    if herc or loki:
        ...
        mt "Семён, что за кошмар у тебя на шее?" # фраза не стыкуется с продолжением
    ...
    dreamgirl "Ну-ну. Теперь-то, с одеждой в стирке, сам обряженный как записной клоун, разве что без галстука, уйдёшь ты очень далеко и добьёшься очень многого." 
