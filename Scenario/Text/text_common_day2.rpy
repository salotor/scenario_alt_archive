...
label alt_day2_dinner:
    ...
    if len(list_clubs_7dl) > 1: 
        ...
        menu:
            "А я и в газету, и на музыку успею!" if (alt_day2_rendezvous == 1) and alt_day2_club_join_musc and alt_day2_club_join_nwsppr:
                mt "Уверен?"
            ...
            "Давайте стенгазету" if alt_day2_club_join_nwsppr:
            ...
            "Давайте бадминтон?" if alt_day2_club_join_badmin:
                ...
                $ alt_day2_club_join_volley = False 
                $ alt_day2_club_join_musc = False
            "Останусь в музкружке!" if alt_day2_club_join_musc:
