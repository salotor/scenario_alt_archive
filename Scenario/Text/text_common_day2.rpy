    ...
    menu:
        "С аниме-девочкой":
            ...
            if 'music' in list_clubs_7dl:
                ...
                mi "Не забудь, ты обещал заходить в клуб. Если надумаешь записаться — милости прошу!"    # возможен вариант, когда Сёма уже записался, но когда Ольга заставила выбирать - отказался от музклуба. Нужен какой-то флаг и иная реплика
