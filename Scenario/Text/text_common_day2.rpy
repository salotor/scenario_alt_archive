...
label alt_day2_bf:
    ...
    menu:
        "Сесть со Славей":
            ...
            "Кокетничающей? {w}Только не так, как раньше."
...
label alt_day2_siesta:
    ...
    th "То бишь, географических зацепок ноль, хронологических отметок…"
    if counter_sl_7dl < 1:
        "Славя что-то заикалась насчёт восемьдесят девятого… Мать моя женщина, тридцать лет без малого — в прошлое!"
