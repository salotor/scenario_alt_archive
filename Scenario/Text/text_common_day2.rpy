label alt_day2_begin:
    ...
    if (alt_day1_d3_transform or not (herc or loki)) and (counter_sl_7dl == 0) and (alt_day_binder != 1):
...
label alt_day2_lineup:
    ...
    if (alt_day_binder != 1) and (counter_sl_7dl == 0) and (alt_day1_d3_transform or not (herc or loki)):
        "Бикини её, опять же."
    else:
    ...
    menu:
        ...
        "Алиса":
            ...
            if lp_dv >= 3:
                ...
                if (alt_day1_d3_transform or not (herc or loki)) and (counter_sl_7dl == 0):
        ...
        "Лена" if not 'un_rej' in list_d2_convoy_7dl:
            ...
            if herc or loki and not alt_day1_d3_transform:
                "Лёгкая, но чётко выраженная неприязнь, которой лично я не вижу никаких объяснений."
            elif alt_day1_d3_transform or not (herc or loki) and (counter_sl_7dl == 0):
...
label alt_day2_event_sport_area1:
    ...
    if loki and not alt_day1_d3_transform and (counter_sl_7dl == 0):
...
label alt_day2_event_medic_house1:
    ...
    if alt_day_binder != 1:
        ...
        elif loki and (counter_sl_7dl == 0):
...
label alt_day2_un_herc_date:
    ...
    elif alt_day1_un_dated and not alt_day1_d3_transform:
    ...
    if alt_day1_un_dated and not alt_day1_d3_transform:
