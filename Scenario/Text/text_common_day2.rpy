...
label alt_day2_grand_escape:
    ...
    "Ещё пять минут — и Ульяна спрыгнула на песок. Вслед за ней зашёл и я, предварительно втащив лодку поглубже на берег и примотав её к дереву."
    us "Что там дальше?"
...
label alt_day2_supper:
    ...
    th "Ха! Торт!"
    th "Для ничего не подозревающей вожатой она на подозрение быстро сориентировалась."
    ...
    "Впилась в одну из половинок зубами, отхватив сразу половину кремовой башенки!"
    mt "Ульяна!"
