        ...
        menu:
            "Спросить о штекере":
                ...
                if counter_sl_cl == 1:
                    ...
                    me "Так что бегунок, да." #при прохождении за Дрища Шурик не спрашивает о бегунке, а Семён отвечает ему так, удто вопрос быд
                    "Глупо сказал я."
...
label alt_day2_dinner:
    ...
    "Ольга Дмитриевна, как и положено вожатой, уже караулила у входа, при этом вид имела подозрительно цветущий и отдохнувший. Видели мы… Их работу." #Дрищ, пойдя со Славей, НЕ встречает на пляже Ольгу, так что не мог видеть.
...
label alt_day2_slot_sl:
    ...
    sl "Там… Пойдёшь вдоль стены, увидишь." #в тексте ограда, а на фоне лес
    ...
    "Девушка остановилась рядом, лёгко дыша." #лЁгко — опечатка или авторский ритм?
