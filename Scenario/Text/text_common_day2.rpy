...
label alt_day2_siesta:
    ...
    th "Сами в свою очередь игнорируют такие, казалось бы, маловажные и несложные вопросы, как название ближайших населённых пунктов…"    #### Сёма пытается спрашивать про географические названия только в 2 местах - у Ульки при Великом Побеге (alt_day2_us_escape) и, если во время обхода зашёл на пляж без Слави, он спрашивает у Ольги. В остальных случаях строчки про "игнорируют вопросы..." неуместны
