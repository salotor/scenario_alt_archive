        ...
        "С аниме-девочкой":
            ...
            if 'music_club' in list_voyage_7dl:
                ...
                menu:
                    ...
                    "Вздохнуть":    # это не должно карму урезать разве?
                        ...
                        "Она тут же обиженно поджала нижнюю губку и, собрав приборы со стола, встала и ушла."    # обиженный спрайт Мику нужен
                        window hide
                        return
            else:
                if alt_day_binder == 1:
