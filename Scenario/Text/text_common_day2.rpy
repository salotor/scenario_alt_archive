...
label alt_day2_walk_sl:
    ...
    if not herc:
        ...
        window hide
        scene bg ext_house_of_mt_day with dissolve
        "Крейсерская скорость Слави отличается от числа Маха крайне незначительно — так что перемещения по лагерю обычно занимают считанные минуты."    # Число Маха это отношение скорости тела к скорости звука. Безразмерная величина. Поэтому скорость Слави могла незначительно отличаться от скорости звука.
