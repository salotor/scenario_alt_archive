label alt_day0_start_d:
    ...
    "Наступая между корней сосен, между камнями — приветом от ледника, что гостил здесь сорок тысяч лет назад — я лечу вниз по склону. Мне немного грустно от того, что все мальчики нашли здесь себе кого-то, кто хотя бы не отказывается танцевать с ними." # народ в группе пишет, что 20 тысяч лет https://ru.wikipedia.org/wiki/Последний_ледниковый_максимум
