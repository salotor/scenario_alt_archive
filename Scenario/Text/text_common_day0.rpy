label alt_day0_start_d:
    ...
    th "Не твоё дело."
    "Я усилием воли отключил посторонний поток сознаний и, откинувшись на подушку, выпустил в потолок целый клуб дыма."
    ...
    "За окном была такая же пустынная улица — почему-то в с утра пораньше в предновогодние дни никто вдруг не спешил по магазинам."
    ...
    "Между тем за окном уже понемногу рассветало."
    window hide
