label alt_day0_start_d:
    ...
    "Я играл в эту игру каждое утро — приблизительно в три часа пополудни, воскресая ото сна носом в клавиатуру." # возможно, стоит указать, что вставать в 5 утра для него нехарактерно.
    ...
    "За окном была такая же пустынная улица — почему-то в три часа дня, в предновогодние дни, никто вдруг не спешил по магазинам." # Дрищ просыпается теперь в 5 утра, умывается, и вот уже три часа дня, только в это время он задумывается о завтраке.
    ...
    dreamgirl "Ну… А почему ты не паникуешь? Почему не орёшь «кто здесь» или хотя бы не констатируешь с умным видом «делириум тременс»?" #сначала Дрищ говорит с Шизой, как будто всё так и должно быть, а теперь Шиза по старому сценарию с ним "знакомится"
    me "А это поможет?"
...
label alt_day0_start_h:
    ...
    "Но некоторым просто не повезло родиться в неправильном месте." # два предложения заканчиваются словом "месте"
