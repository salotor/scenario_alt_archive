label alt_day0_start_d:
    ...
    th "Не твоё дело."
    "Я усилием воли отключил посторонний поток сознаний и, откинувшись на подушку, выпустил в потолок целый клуб дыма." # поток сознаниЙ?
    ...
    "Я играл в эту игру каждое день — приблизительно в три часа пополудни, воскресая ото сна носом в клавиатуру."
    "Хотя с моим образом жизни все режимы давным-давно накрылись медным тазом."
    "Я не был и не ночным жителем, и дневным меня назвать было тудно."
    stop sound_loop
    ...
    dreamgirl "Только не предлагай мне это, у меня ни рук, ни… Скажи, а почему ты дома сидишь? Вечер-то какой! Айда гулять!" # сейчас 7 утра
    me "У меня утро." # у всех утро
...
label alt_day0_start_l:
    ...
    if persistent.d3_loki: # не вписывается в текст
