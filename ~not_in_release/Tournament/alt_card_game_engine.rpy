...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    def mark_amount_cards_alt(cardset, combo, value, minor):        # маркируем карты по количеству - передаем кардсет, комбинацию, старшую карту, младшую пару
        ...
        while j >= 0:                                                # перебираем карты со старшей
            ...
            elif combo in [7,3,1]:                                  # если простая последовательность     #moded
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    # определяем, какие карты входят в комбинацию
        if combo_result in [9,8,5]:                                                     # если флеши     #moded
...
# +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    # .............................................
        ...
        if poker_hand[0] in [0,4,5,8]:                      # если старшая карта или масти, кроме рояля, или стрит     #moded
        ...
        if poker_hand[0] in [5,8,9]:                        # если собраны масти     #moded
