...
# -----------------------------------------------------------------------------------------------
    alt_table_mutual_taunt = {
        ...
        "dv+sh":    " ",    # Алиса + Шурик
        "dv+sl":    " ",    # Алиса + Славя
        "dv+un":    "Алиса подмигнула, а Лена, как у крыльца, съёжилась и попыталась спрятаться под стол.", # Алиса + Лена
        "dv+us":    " ",    # Алиса + Ульяна
        "me+mi":    " ",    # Семён + Мику
        "me+mz":    " ",    # Семён + Женя
        "me+sh":    " ",    # Семён + Шурик
...
# ------------------------------------------- Шурик
        ...
        "sh>us":    [       # Шурик > Ульяна
                        [th, "( ПРОВЕРКА ОБЩЕГО СЛОВАРЯ. Шурик выиграл у Ульяны. )"],                               # ДЛЯ ПРОВЕРКИ СЛОВАРЯ
                        [None, "Наш главный кибернетик оказался не робкого десятка; угроз Ульяны не испугался."],  
                        "*",
                        [us, "«...а завтра с утра ждите в гости...»"],
                        [None, "Судя по донесшемуся обрывку фразы, мелкая решила отомстить за поражение."]
                    ],
# ------------------------------------------- Славя
        "sl>dv":    [       # Славя > Алиса
                        [None, " "],
...
# ------------------------------------------- Ульяна
        ...
        "us>sh":    [       # Ульяна > Шурик
                        [th, "( ПРОВЕРКА ОБЩЕГО СЛОВАРЯ. Ульяна обыграла Шурика. )"],                 # ДЛЯ ПРОВЕРКИ СЛОВАРЯ
                        [None, "Видимо, угрозы мелкой проказницы возымели-таки действие."],
                        "*",
                        [sh, "«... и, надеюсь, отныне ты к нам в клуб дорогу забудешь...»"],
                        [None, "Мне удалось расслышать только часть фразы Шурика."]
                    ],
        "us>sl":    [       # Ульяна > Славя
                        [None, " "],
                        "*",
